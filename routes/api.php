...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::post('login', [AuthController::class, 'login']);//->middleware('RequestResponseLoggingAspect');
    Route::post('logout', [AuthController::class, 'logout']);
    Route::delete('deletemyaccount', [AuthController::class, 'DeleteMyAccount']);
});
 Route::middleware('auth:api','RequestResponseLoggingAspect')->group(function ()
 {
 ...
 Route::delete('delete_file_from_group',[GroupController::class,'deletefile_from_group']);
 ...
 Route::get('getipanddata/{city}',[FileController::class,'getData']);
 Route::get('getclient',[AuthController::class,'getClientIps']);
 });
